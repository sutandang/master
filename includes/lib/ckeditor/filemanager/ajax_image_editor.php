...
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/ajaximageeditor_c.js"></script>
...
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/jqModal.js"></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/rotate.js"></script>
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/interface.js"></script>-->


<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/ajaximageeditor.js"></script>
...
<link href="<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/css/ajaximageeditor.css" type="text/css" rel="stylesheet" />
<link href="<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/css/jqModal.css" type="text/css" rel="stylesheet" />
...
<div id="imageArea">
    <div id="imageContainer">
    	<img src="<?php echo str_replace(CONFIG_SYS_DEFAULT_PATH, CONFIG_SYS_DEFAULT_URL, $path); ?>" name="<?php echo basename($path); ?>" width="<?php echo $imageInfo['width']; ?>" height="<?php echo $imageInfo['height']; ?>" />
    </div>
    <div id="resizeMe">
    	<div id="resizeSE"></div>
    	<div id="resizeE"></div>
    	...
    	<div id="resizeSW"></div>
    	<div id="resizeS"></div>
		<img id="loading" style="display:none;" src="<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/images/ajaxLoading.gif" />
    </div>
</div>
    <div id="hiddenImage">
    </div>
