<?php
	...
	if(CONFIG_SYS_VIEW_ONLY || !CONFIG_OPTIONS_EDITABLE)
	{
		...
		$session->gc();
		$_GET['path'] = empty($_GET['path'])?CONFIG_SYS_DEFAULT_PATH . "ajax_image_editor_demo.jpg":$_GET['path'];
...
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/ajaxtexteditor_c.js"></script>
...
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/ajaxtexteditor.js"></script>
-->
<script type="text/javascript" src="<?php echo DIR_AJAX_URL; ?>jscripts/edit_area/edit_area_full.js"></script>
...
<link href="<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/css/ajaxtexteditor.css" type="text/css" rel="stylesheet" />
...
<div id="windowProcessing" class="jqmWindow" style="display:none">
	...
	<p><img src="<?php echo DIR_AJAX_URL; ?>theme/<?php echo CONFIG_THEME_NAME; ?>/images/loading.gif" /></p>
</div>
