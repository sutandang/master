<?php
	...
	define('DIR_AJAX_ROOT', _ROOT . 'includes/lib/ckeditor/filemanager/') ; // the path to ajax file manager
	define('DIR_AJAX_URL', _URL . 'includes/lib/ckeditor/filemanager/') ; // the path to ajax file manager
